...
const VrHero: FC<VrHeroProps> = ({ hero }) => {
  const {
    images,
  ...
  return (
    <section
      className={`grid items-center justify-center min-h-screen bg-[linear-gradient(180deg,rgba(15,23,42,0.4)_60%,rgba(9,9,11,1)_100%),url('/assets/media/vr-hero-background.jpg')] bg-bottom bg-cover bg-no-repeat`}
    >
      <NrContainer
        styles={{
